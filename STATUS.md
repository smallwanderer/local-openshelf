...
가장 최근 변경의 핵심은 **AI 검색 retriever 점수 계산 안정화**입니다. dense 후보 검색은 inner product를 기본으로 사용하고, 문서 점수 pooling은 normalized log-sum-exp로 조정했습니다. 이 변경으로 낮은 hybrid 점수의 여러 chunk가 문서 최종 점수를 과도하게 끌어올리는 문제를 완화했습니다.
...
- 검색된 evidence chunk를 기반으로 문서 Q&A 제공
- 답변에 사용된 파일명, section, page, chunk 근거 표시
- 단일 문서 질의와 여러 문서 질의 모드 분리
